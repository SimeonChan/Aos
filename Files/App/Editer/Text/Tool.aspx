    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div style="float: left;">
                <div class="pub-left">
                    <a href="javascript:;" onclick="<%=szClick%>">
                        <img src="<%=pg.PageArgs.UIPath%>images/back.png" width="24" height="24" alt="" style="padding-top: 0px;" /></a>
                </div>
            ...
            <%
                ...
                szClick = "Page.Functions.TextEditer.Save('" + pg.PageArgs.UIPath + "','" + pg.PageArgs.UID + "_TextArea','" + szPath + "');";
            %>
            <div style="float: left;">
                <div class="pub-left">
                    <a href="javascript:;" onclick="<%=szClick%>">
                        <img src="<%=pg.PageArgs.UIPath%>images/Tool_Save.png" width="24" height="24" alt="" style="padding-top: 0px;" /></a>
                </div>
                <div class="pub-left" style="padding: 2px 0px 0px 5px;"><a href="javascript:;" onclick="<%=szClick%>">保存</a></div>
                <div class="pub-clear"></div>
            </div>
            <div style="float: left; padding: 0px 8px 0px 8px; height: 24px"><span></span></div>
            <%
                szClick = "Page.UI.Open('" + pg.PageArgs.UID + "','','个人设置','" + pg.PageArgs.UIPath + "','Process.aspx', {Arg_Path:'" + szPath + "'});";
            %>
            <div style="float: left;">
                <div class="pub-left">
                    <a href="javascript:;" onclick="<%=szClick%>">
                        <img src="<%=pg.PageArgs.UIPath%>images/Tool_Refresh.gif" width="24" height="24" alt="" style="padding-top: 0px;" /></a>
                </div>
            ...
            <div style="float: left;">
                <div class="pub-left">
                    <a href="javascript:;" onclick="<%=szClick%>">
                        <img src="<%=pg.PageArgs.UIPath%>images/Exit.png" width="24" height="24" alt="" style="padding-top: 0px;" /></a>
                </div>
