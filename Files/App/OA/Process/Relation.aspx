                    ...
                    switch (gTabs.SystemRelation.Structure.Type) {
                        case 1://Page模式
                            ...
                            if (gTabs.SystemRelation.Structure.Column == "ID") {
                                pg.PageRequest.SetPageOpen(gTabs.SystemRelation.Structure.Path + "?ID=" + glngID + "&Azalea_SessionID=" + this.SessionID + "&Azalea_AuthID=" + this.AuthorizeID);
                            } else {
                                using (Ly.DB.Dream.SystemTables.ExecutionExp st = new Ly.DB.Dream.SystemTables.ExecutionExp(base.ConnectString)) {
                                    ...
                                    using (Ly.Data.SQLClient Conn = new Ly.Data.SQLClient(base.ConnectString)) {
                                        ...
                                        if (Conn.DataReader.Read()) {
                                            ...
                                            pg.PageRequest.SetPageOpen(gTabs.SystemRelation.Structure.Path + "?" + gTabs.SystemRelation.Structure.Column + "=" + sValue+ "&Azalea_SessionID=" + this.SessionID + "&Azalea_AuthID=" + this.AuthorizeID);
                                        } else {
                        ...
                        case 2://DS脚本模式
                            ...
                            //if (pg.XPort["Reload"].Value == "1") {
                            //    pg.XPort.SetAjaxScript()
                            //}
                        ...
                        default://标准单关联模式
                            ...
                            using (ClsAjaxRequest.Arg arg = new ClsAjaxRequest.Arg(pg)) {
                                ...
                                //js.SetAjaxLoad(pg.PageArgs.Process_ElementID, sPath + "Main.aspx", arg);
                                js.SetAjaxScript("/Files/App/OA/Process/Process.aspx", arg);
                            }
