    ...
    <form id="form1" runat="server">
        <div>
            ...
            <% 
                ...
                szFilters = gTable2D.GetTableFilters();
            ...
            <div style="position: absolute; top: 0px; left: 0px; z-index: 1; height: 30px; width: 100%; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; padding: 6px 0px 0px 6px; background: #DDDDDD; overflow: hidden;">
                ...
                <%if (!bDate) { %>
                <!--工具栏|查看-->
                <%szScript = "Page.Functions.Table.View('" + pg.PageArgs.Path + "','" + pg.PageArgs.UID + "','" + gSystemTables.Structure.Text + "'," + gintWidth + "," + gintHeight + ",{" + gstrArgs + "," + gAddJson.Object.ToString().Substring(1, gAddJson.Object.ToString().Length - 2).Replace("\"", "'") + "});"; %>
                ...
                <!--工具栏|修改-->
                <%if (slm.Edit) { %>
                <%szScript = "Page.Functions.Table.Edit('" + pg.PageArgs.Path + "','" + pg.PageArgs.UID + "','" + gSystemTables.Structure.Text + "'," + gintWidth + "," + gintHeight + ",{" + gstrArgs + "," + gAddJson.Object.ToString().Substring(1, gAddJson.Object.ToString().Length - 2).Replace("\"", "'") + "});"; %>
                <div class="pub-left" style="padding: 0px 3px 0px 5px;">
                    <a href="javascript:;" onclick="<%=szScript%>">
                ...
                <!--工具栏|删除-->
                <%if (slm.Delete) { %>
                <% szScript = "Page.Functions.Table.Delete('" + pg.PageArgs.UID + "','" + pg.PageArgs.Path + "',{" + gstrArgs + "});";%>
                <div class="pub-left" style="padding: 0px 3px 0px 5px;">
                    <a href="javascript:;" onclick="<%=szScript%>">
                ...
                <%} %>
                <%szScript = "Page.Functions.Table.Filter('" + pg.PageArgs.Path + "','" + pg.PageArgs.UID + "', '', 800, 480, {});"; %>
                <div class="pub-left" style="border-left: 1px solid #CCCCCC; margin-left: 5px; padding: 0px 3px 0px 10px;">
                    <a href="javascript:;" onclick="<%=szScript%>">
                ...
                <%szScript = "Page.Functions.Table.Order('" + pg.PageArgs.UID + "',{});"; %>
                <div class="pub-left" style="padding: 0px 3px 0px 5px;">
                    <a href="javascript:;" onclick="<%=szScript%>">
                ...
                <%
                    szClick = "javascript:;";
                    szScript = "Page.Functions.Table.Command('" + pg.PageArgs.UID + "','" + pg.PageArgs.Path + "',{Arg_Index:" + (gintIndex + 1) + ",Arg_Relation:'" + gSystemRelation.StructureCollection[i].ID + "'});";
                %>
                <%
                    ...
                    <div style="float: left; padding: 0px 0px 0px 5px;">
                        <%
                            ...
                            using (ClsAjaxPageArgs Arg = new ClsAjaxPageArgs(pg.PageArgs)) {
                                ...
                                szSettingScript = "Page.Functions.Table.KeySearch('" + pg.PageArgs.UID + "');";
                            }
                        %>
                    ...
                    <div style="float: left; background: #fff;">
                        ...
                        <%
                            ...
                            using (ClsAjaxPageArgs Arg = new ClsAjaxPageArgs(pg.PageArgs)) {
                                ...
                                szScriptKeyDelete = "Page.Functions.Table.KeySearchClear('" + pg.PageArgs.UID + "');";
                            }
                        %>
                        ...
                        <%} %>
                        <%
                            szClick = "Page.Functions.Table.Filter('" + pg.PageArgs.Path + "','" + pg.PageArgs.UID + "', '', 800, 480, {});";
                        %>
                        <div style="float: left; margin-bottom: 5px;">
                    ...
                    <div style="position: absolute; top: 0px; left: 0px; padding-top: 29px; height: 100%; overflow: hidden; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; z-index: 0;">
                        <div style="height: 100%; overflow-y: scroll; overflow-x: hidden;">
                            <table style="<%=szTabStyle2%> border-collapse: collapse; border-spacing: 0px;">
                                ...
                                %>
                                <tr id="<%=pg.PageArgs.UID%>_tr_line_<%=strID%>" onclick="Page.Functions.Table.Select('<%=pg.PageArgs.UID%>','<%=strID%>');">
