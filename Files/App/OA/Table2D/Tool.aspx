    ...
    <form id="form1" runat="server">
        <div>
            ...
            <%
                ...
                //szClick = "Page.UI.Open('" + pg.PageArgs.UID + "','','" + pg.PageArgs.UITitle + "','" + pg.PageArgs.Path + "','Process.aspx', {Arg_Table:'" + szTable + "',Arg_Page:" + gnPage + ",Arg_Table_Date:'" + szDate + "',Arg_Table_Key:'" + szKey.Replace("\"", "\\\"").Replace("'", "\\'") + "'});";
                //szClick = "Page.Functions.OA.Table.Load('" + pg.PageArgs.UID + "',{});";
                szClick = "Page.Functions.Process.Load('" + pg.PageArgs.UID + "',{});";
            %>
            <div style="float: left;">
                <div class="pub-left">
                    <a href="javascript:;" onclick="<%=szClick%>">
