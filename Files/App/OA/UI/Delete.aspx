    ...
    <form id="form1" runat="server">
        <div>
            ...
            <%
                ...
                dyk.DB.Base.SystemTables.ExecutionExp SystemTables = new dyk.DB.Base.SystemTables.ExecutionExp(this.BaseConnectString);
                ...
                using (ClsAjaxRequest js = new ClsAjaxRequest()) {
                    ...
                    try {
                        ...
                        string szDsSaveing = Pub.IO.ReadAllText(Server.MapPath(SystemTables.Structure.SavePath + "/Del_OnSaving.ds"));
                        ...
                        string szDsSaved = Pub.IO.ReadAllText(Server.MapPath(SystemTables.Structure.SavePath + "/Del_OnSaved.ds"));

                        if (szDsSaved != "") {
                            DsLibrary lib = new DsLibrary(this, this.BaseConnectString, null);
                            using (dyk.Script.Code.Program.Actuator act = new dyk.Script.Code.Program.Actuator(szDsSaved, lib)) {
                                act.Execute();
                            }
                        }
