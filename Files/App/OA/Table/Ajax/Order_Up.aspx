        ...
        <div>
            ...
            <%
                ...
                for (int i = 0; i < obj.Count; i++) {
                    ...
                    if (szName == szColumn) {
                        if (i > 0) {
                            string szOrderTemp = obj[i]["Order"].Value;
                            obj[i]["Name"].Value = obj[i - 1]["Name"].Value;
                            obj[i]["Order"].Value = obj[i - 1]["Order"].Value;
                            obj[i - 1]["Name"].Value = szName;
                            obj[i - 1]["Order"].Value = szOrderTemp;
                        }
