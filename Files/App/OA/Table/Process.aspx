        ...
        <div>
            ...
            <%
                ...
                using (ClsAjaxRequest js = new ClsAjaxRequest()) {
                    ...
                    js.SetScript("Js_OA_Table", pg.PageArgs.Path + "js/Default.js");
                    js.SetStorage("OA_Table_Select_" + pg.PageArgs.UID, "");

                    //储存页面基本参数
                    js.SetStorage("OA_" + pg.PageArgs.UID + "_UITitle", pg.PageArgs.UITitle);
                    js.SetStorage("OA_" + pg.PageArgs.UID + "_UIPath", pg.PageArgs.Path);
                    js.SetStorage("OA_" + pg.PageArgs.UID + "_Path", pg.PageArgs.Path);
                    ...
                    using (ClsAjaxRequest.Arg arg = new ClsAjaxRequest.Arg()) {
                        ...
                        js.SetAjaxLoad(pg.PageArgs.UID, pg.PageArgs.UITool, pg.PageArgs.Path + "Tool.aspx", arg, "->(1/2)加载工具栏...");
                        js.SetAjaxLoad(pg.PageArgs.UID, pg.PageArgs.UIMain, pg.PageArgs.Path + "Main.aspx", arg, "->(2/2)加载主界面...");
                    }
