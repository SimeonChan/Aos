    ...
    <form id="form1" runat="server">
        <div>
            ...
            <% 
                ...
                szFormScript += "$.Dialog.Form.Submit('" + pg.PageArgs.UID + "','" + pg.PageArgs.Path + "Ajax/PwdSave.aspx');";
            ...
            <div style="margin: 10px 0px 10px 10px">
                <div style="float: left;">
                    ...
                    <div style="float: left; padding: 1px 3px 3px 3px;">
            ...
            <%
                ...
                szBgSaveScript += "$.Dialog.Form.DataSet('Process_ElementID','" + pg.PageArgs.Process_ElementID + "');";
                szBgSaveScript += "$.Dialog.Form.DataSet('Process_ID','" + pg.PageArgs.Process_ElementID + "');";
                szBgSaveScript += "$.Dialog.Form.Submit('" + pg.PageArgs.UID + "','" + pg.PageArgs.Path + "Ajax/BgSave.aspx');";
